          ...
          <Row>
            <div className="user_data center_div">
              ...
              <Row>
                ...
                <Col sm={6}>
                  <label><h4>{this.selectedDriver.cashOnDelivery}</h4></label>
                  {!this.selectedDriver.cashOnDelivery || this.selectedDriver.cashOnDelivery === 0 ? null : <Button style={{ 'margin-left': '10px' }} bsStyle="default" onClick={() => this.resetCashOnDelivery(this.selectedDriver)}>{gettext('RESET')}</Button>}
